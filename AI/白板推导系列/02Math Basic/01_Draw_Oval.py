...
# 设置坐标轴名字
ax.text(7, 0.15, '$x_1$', fontsize=10)
ax.text(0.1, 7, '$x_2$', fontsize=10)
ax.text(0.5, 1.5, '$\sqrt{\lambda_1}$', fontsize=20, color="r")
ax.text(1.5, 3, '$\sqrt{\lambda_2}$', fontsize=20, color="g")
ax.text(4.3, 4.3, '$\Delta_1$', fontsize=20, color="steelblue")
ax.text(5, 5, '$\Delta_2$', fontsize=20, color="tomato")
...
plt.title("高斯分布截面示意图", fontproperties=font, fontsize=15)
plt.show()
